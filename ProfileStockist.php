...
<style>
     ...
     $sql = "UPDATE tbStockistMaster SET fdStockistName ='$sname', fdHeadOfficeName ='$hname', fdHeadOfficeAddressLine1 ='$haddress1', fdHeadOfficeAddressLine2 ='$haddress2', fdHeadOfficeCity ='$hcity', fdHeadOfficeState ='$hstate', fdHeadOfficeCountry ='$hcountry', fdHeadOfficePostalCode ='$hpostcode', fdHeadOfficePhoneNumber ='$hphone', fdHeadOfficeEmail ='$hemail', fdStockistLat ='$slatitude', fdStockistLong ='$slagitude', fdOwnerName ='$oname', fdOwnerPhoneNumber ='$ophonenumber', fdOwnerEmail ='$oemail', fdContactPerson1Name ='$cp1name', fdContactPerson1PhoneNumber ='$cp1phonenumber', fdContactPerson1Email ='$cp1email', fdContactPerson2Name = '$cp2name', fdContactPerson2PhoneNumber ='$cp2phonenumber', fdContactPerson2Email='$cp2email', fdManufacturerID ='$mid', fdWebsiteURL ='$hweb1', fdNotes ='$notes', fdWareHouseID ='$whid',fdDate='$date',fdTime='$time', fdProfileImage='$newfilename' WHERE fdStockistID= '$RoleUniqueID' ";
        ...
        if(mysqli_query($conn, $sql)) {
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($emailChanged == 1) {
                    ...
                    sendEmail($conn, 2, $_POST['oemail']);
                } else {
                    // If emailChanged is 1, update fdstatus to 1
                    $fdstatus = 1;
                }
           $sql1 = "UPDATE tbUserMaster SET fdUserFName='$oname', fdEmailAsUserID='$oemail',fdPhoneNumber='$ophonenumber', fdCountry='$hcountry', fdCity='$hcity', fdState='$hstate', fdZipCode='$hpostcode', fdLatitude='$slatitude', fdLongitude='$slagitude', fdProfileImage='$newfilename',fdStatus='$fdstatus' WHERE fdRoleUniqueID= '$sid'";
        if (mysqli_query($conn,$sql1)) {
            ...
            swal.fire({
                ...
                window.location="?ProfileStockist";
            });
            </script>';
        }else {
   ...
   $query = "SELECT * FROM tbStockistMaster WHERE fdStockistID ='$RoleUniqueID'";
    ...
    <div class="col-12 mt-2">
        <div class="card">
            <div class="card-header " style="background-color:#1e88e566;">
                <h4 class="mb-0 text-white"><strong>UPDATE STOCKIST PROFILE</strong></h4>
            </div>
                        ...
                        <div class="row">          
                            <div class="col-sm-12 col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control required-field" id="sname" name="sname" placeholder="Enter Stockist Name" value="<?php echo $rows["fdStockistName"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>  
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                    <input type="text" name="mid" id="mid" class="form-control"  value="<?php echo $rows["fdManufacturerID"];?>" readonly >
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="sid" name="sid" value="<?php echo $RoleUniqueID; ?>"  readonly>                                    
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-lg-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="whid" id="whid" placeholder="Enter Ware House ID" value="<?php echo $rows["fdWareHouseID"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>                                
                                    </div>
                                </div>
                                </div>
</div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="tel" class="form-control" name="hphone" id="hphone" placeholder="Contact No Here" value="<?php echo $rows["fdHeadOfficePhoneNumber"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required> 
                                        <span class="error-message"></span>                                  
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-lg-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9" style="display: flex;">
                                            <input type="text" class="form-control required-field" id="slatitude" name="slatitude" placeholder="Stockist Latitude Here" value="<?php echo $rows["fdStockistLat"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required> 
                                            <span class="error-message"></span>
                                ...
                                <div class="col-sm-12 col-lg-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9" style="display: flex;">
                                            <input type="text" class="form-control required-field" id="slangitude" name="slagitude" placeholder="Stockist Longitude Here" value="<?php echo $rows["fdStockistLong"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>  
                                            <span class="error-message"></span>
                    ...
                    <div class="row">                           
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <button  type="submit" class="btn btn-secondary waves-effect waves-light" name="password" id="password" style="height:35px">Change Password</button>      
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="form-control required-field" id="cp1name"  name="cp1name" placeholder="Contact Person1 Name Here" value="<?php echo $rows["fdContactPerson1Name"]; ?>">   
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control required-field" name="cp1phonenumber" id="cp1phonenumber" placeholder="Contact Person1 No Here" value="<?php echo $rows["fdContactPerson1PhoneNumber"]; ?>">   
