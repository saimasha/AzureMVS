...
function get_confirmed_locations() {
    ...
    // $query = "SELECT fdRetailerLat, fdRetailerLong, fdRetailerID FROM `tbRetailerMaster` WHERE fdRetailerID = '".$_SESSION['fdRoleUniqueID']."'";
    ...
    $query = "SELECT fdLatitude, fdLongitude, fdCustomerID FROM `tbCustomerMaster`";
    $result = mysqli_query($conn, $query);
    ...
    while ($r = mysqli_fetch_assoc($result)) {
        $locations[] = array($r['fdLatitude'], $r['fdLongitude'], $r['fdCustomerID'], '60'); // '40' represents retailer
    }
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div id="legend">
                    ...
                    <div style="display: contents;"><span class="legend-marker" style="background-color: #e1cef0;"></span> Customer</div>
                </div>
...
var centerCoordinates = new google.maps.LatLng(37.6, 40.665);
        ...
        // Update your autocomplete listener to create a new marker at the searched location
    ...
    for (var i = 0; i < locations.length; i++) {
        var distance = google.maps.geometry.spherical.computeDistanceBetween(
         ...
         if (distance <= radius * 1000 && locations[i][3] === '60') {
...
// Add event listener for mouseover event
    ...
    var markerIcon = locations[i][2] && locations[i][3]=== '60' ? '\uf0c0' : '\uf0f8'; 
  var marker = new google.maps.Marker({
...
label: {
    ...
    (locations[i][3] === '60' ? "<strong> CUSTOMER </strong>" : 
    "<strong> RETAILER </strong>") + "</td></tr>\n" + 
