...
<aside class="left-sidebar">
  ...
  <div class="scroll-sidebar">
                ...
                <div class="user-profile position-relative">
                   ...
                   <img src="https://schedarcloud.com/medicineverifications/image/profile/user.png" style="width: 100%;background: no-repeat;padding: 46px;margin-top: -22px;">
                    <!-- User profile image -->
            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        <li class="sidebar-item">
                            <a href="?CustomerScanDetails1" class="sidebar-link">
                                <i class="mdi mdi-adjust"></i>
