...
<?php
  ...
  $updateSql = "UPDATE tbRetailerMaster SET fdRetailerName= '$sname' ,fdStockistID= '$sid',fdDistributorID= '$disid', fdDealerID= '$deaid', fdHeadOfficeName= '$hname', fdHeadOfficeAddressLine1= '$haddress1', fdHeadOfficeAddressLine2= '$haddress2', fdHeadOfficeCity= '$hcity', fdHeadOfficeState= '$hstate', fdHeadOfficeCountry= '$hcountry', fdHeadOfficePostalCode= '$hpostcode', fdHeadOfficePhoneNumber= '$hphone', fdHeadOfficeEmail= '$hemail', fdRetailerLat= '$slatitude', fdRetailerLong= '$slagitude', fdOwnerName= ' $oname', fdOwnerPhoneNumber= '$ophonenumber', fdOwnerEmail= '$oemail', fdContactPerson1Name= '$cp1name',fdContactPerson1PhoneNumber= '$cp1phonenumber', fdContactPerson1Email= '$cp1email', fdContactPerson2Name= '$cp2name',fdContactPerson2PhoneNumber= '$cp2phonenumber', fdContactPerson2Email= '$cp2email', fdWebsiteURL= '$hweb1', fdManufacturerID= '$mid', fdNotes= '$notes', fdDate= '$date', fdTime= '$time', fdProfileImage='$newfilename' WHERE fdRetailerID= '$RoleUniqueID' ";
                ...
                if ($result = mysqli_query($conn, $updateSql)){
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if ($emailChanged == 1) {
                            ...
                            sendEmail($conn, 5, $_POST['oemail']);
                        } else {
                            // If emailChanged is 1, update fdstatus to 1
                            $fdstatus = 1;
                        }
                    $sql1 = "UPDATE tbUserMaster SET fdUserFName='$oname', fdEmailAsUserID='$oemail',fdPhoneNumber='$ophonenumber', fdCountry='$hcountry', fdCity='$hcity', fdState='$hstate', fdZipCode='$hpostcode', fdLatitude='$slatitude', fdLongitude='$slagitude', fdProfileImage='$newfilename',fdStatus='$fdstatus' WHERE fdRoleUniqueID= '$rid'";
                    if (mysqli_query($conn,$sql1)) {
                    echo'<script>Swal.fire({
                        icon: "success",
                        title: "Update Profile Successfully",
                      }).then(function(){
                      window.location ="?ProfileRetailer";
                          });
                      </script>';            
                  } else {
                      echo'<script> Swal.fire({ 
            ...
            if(isset($_POST['password'])){
             ...
             // Fetch the data for the selected Retailer based on RetailerID
             $query = "SELECT * FROM tbRetailerMaster WHERE fdRetailerID = '$RoleUniqueID'";
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card-header" style="background-color:#1e88e566;">
            <h4 class="card-title mb-0 text-white"><strong>UPDATE RETAILER PROFILE</strong></h4>
        </div>
        ...
        <form class="form-horizontal"  method="POST" enctype="multipart/form-data">
            <div class="card-body">
                <h4 class="card-title">Retailer User</h4>
                    <div class="row">                    
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="fname3" class="col-sm-3 text-right control-label col-form-label" style= "white-space: nowrap;">Retailer Name <code>*</code></label>
                                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="nname" class="col-sm-3 text-right control-label col-form-label">Retailer ID <code>*</code></label>
                                <div class="col-sm-9">
                                    <input type="text" class= "form-control" id= "rid" name= "rid" value= "<?php echo $RoleUniqueID?>" readonly>
                                </div>                                    
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="nname" class="col-sm-3 text-right control-label col-form-label" style= "white-space: nowrap;">Stockist ID <code>*</code></label>
                                    <div class="col-sm-9">
                                    <input type="text" class= "form-control" id= "sid" name= "sid" value= "<?php echo $stockistID ?>" readonly>
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="nname" class="col-sm-3 text-right control-label col-form-label" style= "white-space: nowrap;">Distributor ID <code>*</code></label>
                                    <div class="col-sm-9">
                                        <input type="text" class= "form-control" id= "disid" name= "disid" value= "<?php echo $distributorID ?>" readonly>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="nname" class="col-sm-3 text-right control-label col-form-label">Dealer ID <code>*</code></label>
                                <div class="col-sm-9">
                                    <input type="text" class= "form-control" id= "deaid" name= "deaid" value= "<?php echo $dealerID ?>" readonly>
                        ...
                        <div class="col-sm-12 col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="fname3" class="col-sm-3 text-right control-label col-form-label">Manufacturer ID <code>*</code></label>
                                <div class="col-sm-9">
            ...
            <h4 class="card-title">Head Office Details</h4>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="fname2" class="col-sm-3 text-right control-label col-form-label" style= "white-space: nowrap;">Head Office Name <code>*</code></label>
                                <div class="col-sm-9">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="cono12" class="col-sm-3 text-right control-label col-form-label" style= "white-space: nowrap;">Phone Number <code>*</code></label>
                                <div class="col-sm-9">
...
<div class="col-sm-12 col-lg-6">
    <div class="form-group row">
        <label for="cono12" class="col-sm-3 text-right control-label col-form-label">User Photo</label>
        <div class="input-group col-sm-9">
            ...
            <div class="col-sm-3">
                ...
                <img id="userPhoto" src="<?php echo !empty($rows["fdProfileImage"]) ? 'image/profile/'.$rows["fdProfileImage"] : ''; ?>" width="100" align="right" style="float: left; margin-top: -40px; margin-left: 680%;">
            </div>
        </div>
    </div>
</div>
            ...
            <h4 class="card-title">Owner Details</h4>                                           
                <div class="card-body">                                        
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="fname2" class="col-sm-3 text-right control-label col-form-label" style= "white-space: nowrap;">Owner Name <code>*</code></label>
                                <div class="col-sm-9">
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                ...
                                <input type="hidden" id="emailChanged" name="emailChanged" value="0">
                                    <input type="email" class= "form-control required-field" id= "oemail" name= "oemail" value= "<?php echo $rows['fdOwnerEmail'];?>" onblur="validateField(this)" oninput="validateField(this)" onchange="checkEmailChange()" required>
                                    <span class="error-message"></span>
                                </div>                                   
                            </div>
                        </div>
            ...
            <h4 class="card-title">Contact Person1 Details</h4>
                <div class="card-body">                  
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="fname2" class="col-sm-3 text-right control-label col-form-label" style= "white-space: nowrap;">Person1 Name</label>
                                <div class="col-sm-9">
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="cono12" class="col-sm-3 text-right control-label col-form-label" style= "white-space: nowrap;">Phone Number</label>
                                <div class="col-sm-9">
        ...
        <div class="card-body">
            <h4 class="card-title">Contact Person2 Details</h4>
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group row">
                            <label for="fname2" class="col-sm-3 text-right control-label col-form-label" style= "white-space: nowrap;">Person2 Name</label>
                            <div class="col-sm-9">
