...
$query_generated = "SELECT COUNT(*) AS generated_count FROM tbCarton WHERE fdQRCodeCreated = 1 AND fdManufacturerID = '$manufacturerID'";
$query_not_generated = "SELECT COUNT(*) AS remaining_count FROM tbCarton WHERE fdQRCodeCreated = 0 AND fdManufacturerID = '$manufacturerID'";
                ...
                <div class="card">
                        <div class="card-body">
                            <div class="container my-5">
                                <h1 class="card-title">Generate Carton QR Codes in Bulk</h1>
                                 <br>
                                    ...
                                    <table class="rwd-table">
                                        <thead class="bg-info text-white">
                                            <tr>
                                                ...
                                                <th>Total Cartons</th>
                                                <th>Total Qr Generated Cartons</th>
                                                <th>Remaining Cartons</th>
                            ...
                            <?php if ($remaining_count > 0): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        data-target="#scrollable-modal">Cartons Details</button>
                                    <?php endif; ?>
                             </td>
                                            </tr>
                                        </tbody>
...
$query_cartons = "SELECT * FROM tbCarton WHERE fdQRCodeCreated = 1 AND fdManufacturerID = '$manufacturerID'";
$result_cartons = mysqli_query($conn, $query_cartons);
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable custom-width" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header d-flex align-items-center">
                                                <h5 class="modal-title" id="scrollableModalTitle">All Cartons Details</h5>
                            ...
                            <table class="table table-bordered">
                                <thead class="bg-info text-white">
                                    <tr>
                                        ...
                                        <th>MedicineID</th>
                                        <th>TotPktsInCarton</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result_cartons)): ?>
                                    <tr>
                                        <td><?php echo $row['fdCartonID']; ?></td>
                                        <td><?php echo $row['fdManufacturerID']; ?></td>
                                        <td><?php echo $row['fdMedicineID'] ?></td>  
                                        <td><?php echo $row['fdTotPktsInCarton']; ?></td>
    ...
    $(document).ready(function() {
        $('#generate-bulk-qr').on('click', function() {
            $.ajax({
                ...
                let isAllGenerated = response.includes("All Carton QR codes are already generated.");
                ...
                if (isAllGenerated) {
                    ...
                    title: 'Success',
                    // text: response,
                    text: 'Carton QR Code updated successfully',
                    icon: 'success',
                    confirmButtonText: 'OK'
                }).then((result) => {
