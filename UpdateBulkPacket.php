...
$query_generated = "SELECT COUNT(*) AS generated_count FROM tbPacket WHERE fdQRCodeCreated = 1 AND fdManufacturerID = '$manufacturerID'";
$query_not_generated = "SELECT COUNT(*) AS remaining_count FROM tbPacket WHERE fdQRCodeCreated = 0 AND fdManufacturerID = '$manufacturerID'";
                ...
                <div class="card">
                        <div class="card-body">
                            <div class="container my-5">
                                <h1 class="card-title">Generate Packet QR Codes in Bulk</h1>
                                 <br>
                                    ...
                                    <table class="rwd-table">
                                        <thead class="bg-info text-white">
                                            <tr>
                                                ...
                                                <th>Total Packets</th>
                                                <th>Total Qr Generated Packets</th>
                                                <th>Remaining Packets</th>
                            ...
                            <?php if ($remaining_count > 0): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        data-target="#scrollable-modal">Packets Details</button>
                                    <?php endif; ?>
                             </td>
                                            </tr>
                                        </tbody>
...
$query_Packets = "SELECT * FROM tbPacket WHERE fdQRCodeCreated = 1 AND fdManufacturerID = '$manufacturerID'";
$result_Packets = mysqli_query($conn, $query_Packets);
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable custom-width" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header d-flex align-items-center">
                                                <h5 class="modal-title" id="scrollableModalTitle">All Packets Details</h5>
                            ...
                            <table class="table table-bordered">
                                <thead class="bg-info text-white">
                                    <tr>
                                        ...
                                        <th>MedicineID</th>
                                        <th>TotStripsInPkt</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result_Packets)): ?>
                                    <tr>
                                        <td><?php echo $row['fdPacketID']; ?></td>
                                        <td><?php echo $row['fdManufacturerID']; ?></td>
                                        <td><?php echo $row['fdMedicineID'] ?></td>  
                                        <td><?php echo $row['fdTotStripsInPkt']; ?></td>
    ...
    $(document).ready(function() {
        $('#generate-bulk-qr').on('click', function() {
            $.ajax({
                ...
                let isAllGenerated = response.includes("All Packet QR codes are already generated.");
                ...
                if (isAllGenerated) {
                    ...
                    Swal.fire({
                        title: 'Success',
                        // text: response,
                        text:'Packet QR Code updated successfully',
                        icon: 'success',
                        confirmButtonText: 'OK'
                    }).then((result) => {
