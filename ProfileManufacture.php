...
$time = date('H:i:s', strtotime($currentDateTime));
        ...
        $sql = "SELECT * FROM tbManufacturerMaster WHERE fdManufacturerID = '$RoleUniqueID' ";
  ...
  if(isset($_POST['updatebtn'])){
    ...
    move_uploaded_file($tempname, $folder);
        ...
        $sql = " UPDATE  tbManufacturerMaster  SET fdManufacturerName ='$mname', fdIndustryID ='$iid', fdGroupID='$gid',fdHeadOfficeName ='$hname',fdHeadOfficeAddressLine1 ='$haddress1', fdHeadOfficeAddressLine2 ='$haddress2', fdHeadOfficeCity ='$hcity', fdHeadOfficeState ='$hstate', fdHeadOfficeCountry ='$hcountry', fdHeadOfficePostalCode = '$hpostcode', fdHeadOfficePhoneNumber = '$hphone', fdHeadOfficeEmail ='$hemail',fdHighestAuthorityName ='$haname',fdHighestAuthorityPosition ='$haposition', fdHighestAuthorityPhoneNumber ='$haphonenumber', fdHighestAuthorityEmail ='$haemail', fdContactPerson1Name ='$cp1name',fdContactPerson1PhoneNumber ='$cp1phonenumber', fdContactPerson1Email ='$cp1email', fdContactPerson2Name='$cp2name',fdContactPerson2PhoneNumber ='$cp2phonenumber', fdContactPerson2Email ='$cp2email', fdWebsiteURL ='$mweb1', fdManufacturerLat ='$mlatitude', fdManufacturerLong ='$mlongitude', fdNotes ='$mnotes', fdDate ='$date', fdTime ='$time' , fdProfileImage='$newfilename' WHERE fdManufacturerID = '$RoleUniqueID'";
      //echo $sql;
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($emailChanged == 1) {
        ...
        sendEmail($conn, 1, $_POST['haemail']);
    } else {
        // If emailChanged is 1, update fdstatus to 1
        $fdstatus = 1;
    }

            $sql1 = "UPDATE tbUserMaster SET  fdUserFName='$haname', fdEmailAsUserID='$haemail',fdPhoneNumber='$haphonenumber', fdCountry='$hcountry', fdCity='$hcity', fdState='$hstate', fdZipCode='$hpostcode', fdLatitude='$mlatitude', fdLongitude='$mlongitude', fdProfileImage='$newfilename',fdStatus='$fdstatus' WHERE fdRoleUniqueID= '$mid'";
        if (mysqli_query($conn,$sql1)) {
            echo'<script>Swal.fire({
              icon: "success",
              title: "Updated Successfully",
            }).then(function(){
                window.location ="?ProfileManufacture";
                });
            </script>';            
        }else {
            echo'<script>Swal.fire({ 
...
function checkEmailChange() {
    ...
    var newEmail = document.getElementById('haemail').value;
...
<div class="row">
    <div class="col-12 mt-2">
        <div class="card">
            ...
            <h4 class="mb-0 text-white"><strong>PROFILE MANUFACTURER</strong></h4>
            </div>
            <hr style="margin-top: -2px; margin-bottom: -1px; background: grey;opacity: 0.5;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">     
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                            <input type="text" class="form-control required-field" id="mname" name="mname" placeholder="Enter Manufacturer Name" value="<?php echo $rows["fdManufacturerName"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>
                        ...
                        <div class="col-sm-12 col-lg-6">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control required-field" id="mid" name="mid"  value="<?php echo $RoleUniqueID; ?>" readonly> 
                                <span class="error-message"></span>
        ...
        <div class="col-sm-12 col-lg-6">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <select name="iid" id="iid" class="form-control required-field" onblur="validateField(this)" oninput="validateField(this)" required>
                        ...
                        foreach ($result as $row) {
                            $selected = ($row["fdSlno"] == $rows["fdIndustryID"]) ? "selected" : "";
                            echo '<option value="' . $row["fdSlno"] . '" ' . $selected . '> ' . $row["fdIndustryID"] . ' </option>';
        ...
        <div class="col-sm-12 col-lg-6">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <select name="gid" id="gid" class="form-control required-field"onblur="validateField(this)" oninput="validateField(this)" required>
                        ...
                        foreach ($result as $row) {
                            $selected = ($row["fdGroupID"] == $rows["fdGroupID"]) ? "selected" : "";
                            echo '<option value="' . $row["fdGroupID"] . '" ' . $selected . '> ' . $row["fdGroupName"] . ' </option>';
...
<div class="row">
    ...
    <div class="form-group row ">
        ...
        <div class="col-sm-8">
        <input type="text" class="form-control " id="mweb1" name="mweb1" placeholder="http://" value="<?php echo $rows["fdWebsiteURL"]; ?>"> 
        </div>  
...
<div class="row">
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="form-group row">
            ...
            <div class="col-sm-8">
            <input type="email" class="form-control required-field" id="hemail" name="hemail" placeholder="Email Here" value="<?php echo $rows["fdHeadOfficeEmail"]; ?>">
            </div>      
...
<div class="row">
    <div class="col-sm-12 col-lg-6">
        <div class="form-group row">
            ...
            <input type="text" class="form-control required-field" id="mlatitude" name="mlatitude" placeholder="Manufacturer Latitude Here" value="<?php echo $rows["fdManufacturerLat"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>
            <span class="error-message"></span>
...
<div class="col-sm-12 col-lg-6">
    <div class="form-group row">
        ...
        <div class="col-sm-8" style="display: flex;">
        <input type="text" class="form-control required-field" id="mlongitude" name="mlongitude" placeholder="Manufacturer Longitude Here" value="<?php echo $rows["fdManufacturerLong"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>
        <span class="error-message"></span>
...
<script>
    ...
    var updatedLatitude = <?php echo $rows["fdManufacturerLat"]; ?>;
    document.getElementById('mlatitude').value = updatedLatitude;
}

function refreshLongitude() {
    // Get the updated longitude value from your data source and set it in the input field
    var updatedLongitude = <?php echo $rows["fdManufacturerLong"]; ?>;
    document.getElementById('mlongitude').value = updatedLongitude;
}
  ...
  <script>
    ...
    function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('mapCanvas'), {
            center: { lat: <?php echo $rows['fdManufacturerLat']; ?>, lng: <?php echo $rows['fdManufacturerLong']; ?> },
            zoom: 16
        });
        ...
        marker = new google.maps.Marker({
            position: { lat: <?php echo $rows['fdManufacturerLat']; ?>, lng: <?php echo $rows['fdManufacturerLong']; ?> },
            map: map,
            draggable: true,
            title: 'Manufacture Location'
        });
...
<div class="card-body">
    ...
    <div class="col-sm-8">
    <input type="text" class="form-control required-field" id="haname"  name="haname" placeholder="Authority Name Here" value="<?php echo $rows["fdHighestAuthorityName"]; ?>"  onblur="validateField(this)" oninput="validateField(this)" required>
    <span class="error-message"></span>
    </div>   
    ...
    <div class="col-sm-8">
    <input type="text" class="form-control required-field" name="haposition" id="haposition" placeholder="Position Name Here" value="<?php echo $rows["fdHighestAuthorityPosition"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>
    <span class="error-message"></span>
    </div> 
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="form-group row">
            ...
            <div class="col-sm-8">
            <input type="tel" class="form-control required-field" id="haphonenumber" name="haphonenumber" placeholder="Contact No Here" value="<?php echo $rows["fdHighestAuthorityPhoneNumber"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>
            <span class="error-message"></span>
            </div>        
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="form-group row">
            ...
            <div class="col-sm-8">
            <input type="hidden" id="previousEmail" name="previousEmail" value="<?php echo $rows['fdHighestAuthorityEmail'];?>">
            <input type="hidden" id="emailChanged" name="emailChanged" value="0">
            <input type="email" class="form-control required-field" id="haemail" name="haemail" placeholder="Email Here" value="<?php echo $rows["fdHighestAuthorityEmail"]; ?>" onblur="validateField(this)" oninput="validateField(this)" onchange="checkEmailChange()" required>
            <span class="error-message"></span>
            </div>        
    ...
    <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="nname" class="col-sm-4 text-right control-label col-form-label">Password </label>
                                <div class="col-sm-8">
                                <button  type="submit" class="btn btn-secondary waves-effect waves-light" name="password" id="password" style="height:35px; weight:60%; "><a href="forgetPassword.php" style="color: white;" >Change Password</a></button>      
  ...
  <div class="row">
    <div class="col-sm-12 col-lg-6">
        <div class="form-group row">
            <label for="email2" class="col-sm-4 text-right control-label col-form-label">Email</label>
            <div class="col-sm-8">
            <input type="email" class="form-control required-field" id="cp1email" name="cp1email" placeholder="Email Here" value="<?php echo $rows["fdContactPerson1Email"]; ?>"> 
        ...
        <div class="row">                            
            <div class="col-sm-12 col-lg-6">
                <div class="form-group row">
                    <label for="email2" class="col-sm-4 text-right control-label col-form-label">Email</label>
                    <div class="col-sm-8">
                    <input type="email" class="form-control" id="cp2email" name="cp2email" placeholder="Email Here" value="<?php echo $rows["fdContactPerson2Email"]; ?>">
                    </div>                                    
                </div>
            </div>
        </div>                                        
    ...
    <div class="row">                            
        <div class="col-sm-12 col-lg-12">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="mnotes" name="mnotes" value="<?php echo $rows["fdNotes"]; ?>">                                    
                    </div>
                </div>
        </div>
    </div>
        ...
        <div class="card-body">
            ...
            <button  type="submit" class="btn btn-warning waves-effect waves-light" name="updatebtn" id="updatebtn" onclick="validateAllRequiredFields()">Update</button>
            </div>
        </div>
</form>
