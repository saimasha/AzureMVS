...
$Query = "SELECT DISTINCT fdCartonID FROM tbCarton WHERE fdManufacturerID = '$manufacturerID'";
...
?>
    <option value="<?php echo $row1["fdCartonID"];?>"><?php echo $row1["fdCartonID"];?></option>
<?php
 }
} else {
