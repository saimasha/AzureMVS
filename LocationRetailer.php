...
function get_confirmed_locations() {
    ...
    $query = "SELECT fdRetailerLat, fdRetailerLong, fdRetailerID FROM `tbRetailerMaster` WHERE fdRetailerID = '".$_SESSION['fdRoleUniqueID']."' OR fdDealerID = '".$_SESSION['fdRoleUniqueID']."' OR fdManufacturerID  = '".$_SESSION['fdRoleUniqueID']."' OR fdDistributorID = '".$_SESSION['fdRoleUniqueID']."' OR fdStockistID = '".$_SESSION['fdRoleUniqueID']."'";
...
<div class="row">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-0" style="font-family:Segoe UI,Arial,sans-serif;"><strong><i class="fas fa-map-marker-alt"></i>  RETAILER LOCATION</strong></h4><br>
                    <div class="pac-card" id="pac-card">
                        <div id="label" style="color:white;font-family:Segoe UI,Arial,sans-serif;font-size: 0.7rem;">
                            Search Location
                        </div>       
