    ...
    if (mysqli_query($conn, $sql)) { 
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($emailChanged == 1) {
                ...
                sendEmail($conn, 3, $_POST['OEmail']);
            } else {
                // If emailChanged is 1, update fdstatus to 1
                $fdstatus = 1;
            }
        $sql1 = "UPDATE tbUserMaster SET fdUserFName='$OName', fdEmailAsUserID='$OEmail',fdPhoneNumber='$OPhonenumber', fdCountry='$HOCountry', fdCity='$HOCity', fdState='$HOState', fdZipCode='$HOPostcode', fdLatitude='$DLlatitude', fdLongitude='$DLlongitude', fdProfileImage ='$newfilename',fdStatus='$fdstatus' WHERE fdRoleUniqueID= '$Did'";
        if (mysqli_query($conn,$sql1)) {
            ...
            echo'<script>Swal.fire({ 
                ...
                window.location="?ProfileDistributor";
            });
            </script>';
            }else {
                echo'<script>Swal.fire({ 
...
if(isset($_POST['password'])){
    $Email = $_POST['OEmail'];
    // $sid = $_POST['sid'];
    $Sql = "SELECT COUNT(*) FROM tbUserMaster WHERE fdEmailAsUserID='$Email'";
    if (mysqli_query($conn, $Sql)) {
        sendEmailforgot($conn, 30, $Email);
        echo '<script>
        swal.fire({
            title: "Reset link has been sent to your email id.",
            text: "Kindly check your email.",
...
$query = "SELECT * FROM tbDistributorMaster WHERE fdDistributorID = '$RoleUniqueID'";
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header" style="background-color:#1e88e566;">
                    <h4 class="card-title mb-0 text-white"><strong>UPDATE DISTRIBUTOR PROFILE</strong</h4> 
                                   </div>
                        ...
                        <div class="row">                    
                            <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                <input type="text"  class="form-control required-field" id="DName" name="DName" placeholder="Enter Distributor Name" value="<?php echo $rows["fdDistributorName"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>
                            ...
                            <div class="col-sm-12 col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                    <input type="text" class="form-control" id="Did" name="Did" value="<?php echo $RoleUniqueID; ?>" readonly> 
                                    </div>                                         
                                  </div>
                              </div>
                              <div class="col-sm-12 col-lg-6">
            ...
            <input type="text" class="form-control" id="sid" name="sid" value="<?php echo $rows["fdStockistID"]; ?>" readonly>
                    ...
                    <div class="col-sm-12 col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                    <input type="text" class="form-control required-field" id="HOName" name="HOName" placeholder="Enter Head Office Name Here" value="<?php echo $rows["fdHeadOfficeName"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>     
                                    <span class="error-message"></span>  
                                    </div>                                   
                                </div>
                            </div>
                            <div class="col-sm-12 col-lg-6">
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-8">
                                    <input type="text" class="form-control" id="HOWeb" name="HOWeb" placeholder="http://" value="<?php echo $rows["fdWebsiteURL"]; ?>" >     
                                    </div>                                     
                                </div>
                            </div>
                    </div>
                    <div class="row">
                            <div class="col-sm-12 col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                    <input type="tel" class="form-control required-field" name="HOPhone" id="HOPhone" placeholder="Contact No Here" value="<?php echo $rows["fdHeadOfficePhoneNumber"]; ?>" onblur="validateField(this)" oninput="validateField(this)"  required> 
                                    <span class="error-message"></span> 
                                    </div>                                        
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-lg-6">
                                ...
                                <div class="col-sm-8">
                                <input type="email" class="form-control required-field" id="HOEemail" name="HOEemail" placeholder="Email Here" value="<?php echo $rows["fdHeadOfficeEmail"]; ?>" > 
...
<div class="col-md-6">
    <div class="form-group row">
        ...
        <div class="col-sm-8">
        <input type="text" class="form-control required-field" id="HOPostcode" name="HOPostcode" placeholder="Post code Here" value="<?php echo $rows["fdHeadOfficePostalCode"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>   
        <span class="error-message"></span>  
        </div>                                                      
    </div>
</div>                                            
...
<div class="row">   
        <div class="col-md-6">
            <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control required-field" id="HOAddress1" name="HOAddress1" placeholder="Address1 Here"  value="<?php echo $rows["fdHeadOfficeAddressLine1"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>
                        <span class="error-message"></span>     
                        </div>                                                      
            </div>
            </div>
<div class="col-md-6">
    <div class="form-group row">
        ...
        <div class="col-sm-8">
        <input type="text" class="form-control" id="haddress2" name="HOAddress2" placeholder="Address2 Here" value="<?php echo $rows["fdHeadOfficeAddressLine2"]; ?>" >                                                    
        </div>       
        </div>
</div>
    </div>                                
...
<div class="col-md-6">
    <div class="form-group row">
        ...
        <input type="text" class="form-control required-field" id="DLlatitude" name="DLlatitude" placeholder="Distributor Latitude Here" value="<?php echo $rows["fdDistrLat"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required> 
        <span class="error-message"></span>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8" style="display: flex;">
        <input type="text" class="form-control required-field" id="DLlongitude" name="DLlongitude" placeholder="Distributor Longitude Here" value="<?php echo $rows["fdDistrLong"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>   
        <span class="error-message"></span>
                ...
                document.getElementById('location').value = 'Geocoding failed: ' + status;
                            ...
                            <!-- <div class="col-sm-12 col-lg-6">
                                <div class="form-group">
                                    <label for="cono12" class="control-label col-form-label">Ware House ID<code>*</code></label>
...
<div class="row">                            
        <div class="col-sm-12 col-lg-6">
            ...
            <input type="email" class="form-control required-field" id="OEmail" name="OEmail" placeholder="Email Here" value="<?php echo $rows["fdOwnerEmail"]; ?>" onblur="validateField(this)" oninput="validateField(this)" onchange="checkEmailChange()" required>      
            <span class="error-message"></span>     
        </div>                                    
            </div>
        </div>
        ...
        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                <button  type="submit" class="btn btn-secondary waves-effect waves-light" name="password" id="password" style="height:35px; width:60%; ">Change Password</button>      
...
<!-- <script>
    function checkEmailChange() {
        ...
        if (previousEmail !== newEmail) {
            // Email has changed, set the hidden input field value to 0
            document.getElementById('emailChanged').value = 0;
        } else {
            // Email has not changed, set the hidden input field value to 1
            document.getElementById('emailChanged').value = 1;
        }
    }
</script> -->
