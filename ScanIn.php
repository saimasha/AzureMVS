...
<div class="container-fluid my-5">
    <div class="card">
        <div class="card-body">
        <h4 class="mb-3">In-Scan Details</h4>
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <button id="hashInButton" class="btn btn-info" type="submit" name="submit1" style="width:10%; float: right; display: none;">Hash In</button>
                            </form>
                ...
                if (response.success) {
                    ...
                    $.each(response.data, function(index, row) {
                        ...
                        $('#tableBody').append('<tr>' +
                            ...
                            '<td style="background: #5af167; color: black;">In-Scan</td>' +
                            '</tr>');
                    });
