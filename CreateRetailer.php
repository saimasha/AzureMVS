...
if(isset($_POST['savebtn'])){
  ...
  $sql = "INSERT INTO tbRetailerMaster (fdRetailerID,fdManufacturerID, fdRetailerName,fdStockistID, fdDistributorID, fdDealerID, fdHeadOfficeName, fdWebsiteURL, fdHeadOfficePhoneNumber,fdHeadOfficeEmail, fdHeadOfficeCountry,fdHeadOfficeState,fdHeadOfficeCity,fdHeadOfficePostalCode, fdHeadOfficeAddressLine1, fdHeadOfficeAddressLine2, fdRetailerLat, fdRetailerLong, fdOwnerName, fdOwnerPhoneNumber, fdOwnerEmail, fdContactPerson1Name,fdContactPerson1PhoneNumber, fdContactPerson1Email, fdContactPerson2Name,fdContactPerson2PhoneNumber, fdContactPerson2Email,  fdNotes, fdDate,fdTime,fdProfileImage) VALUES ('$rid','$mid','$sname','$sid','$disid','$deaid','$hname','$hweb1', '$hphone','$hemail','$hcountry','$hstate','$hcity','$hpostcode','$haddress1', '$haddress2','$slatitude','$slagitude',' $oname','$ophonenumber','$oemail', '$cp1name','$cp1phonenumber','$cp1email','$cp2name','$cp2phonenumber','$cp2email',  '$notes', CURDATE(), '$currentTime','$newfilename') ";

  // echo $sql;

  if (mysqli_query($conn,$sql)) {
    $sql1 = "INSERT INTO tbUserMaster (fdRoleUniqueID, fdUserFName, fdUserLName, fdEmailAsUserID, fdPassword, fdPhoneNumber, fdRoleID, fdCountry, fdCity, fdState, fdZipCode, fdLatitude, fdLongitude,fdRegistrationDate, fdProfileImage, fdCompanyID)
    VALUES ('$rid', '$oname', '$oname','$oemail', '$pass', '$ophonenumber', '$roleid', '$hcountry', '$hcity', '$hstate', '$hpostcode', '$slatitude', '$slagitude', CURDATE(), '$newfilename','$companyid')";
    if (mysqli_query($conn,$sql1)) {
        sendEmail($conn, 5, $oemail);
...
<div class="col-12">
    <div class="card"> 
        <div class="card-header" style="background-color:#1e88e566;">
            <h4 class="mb-0 text-white"><strong>CREATE RETAILER </strong></h4>
        </div>
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="fname3" class="col-sm-4 text-right control-label col-form-label" style= "white-space: nowrap;">Retailer Name <code>*</code></label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control required-field" id="sname" name="sname" placeholder="Retailer Name Here"  onblur="validateField(this)" oninput="validateField(this)"
                                        required>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" value="Retailer" readonly>
            <input type="hidden" name="roleid" value="RTLR">
            <span class="error-message"></span>
        </div>
    </div>
</div>
                    ...
                    <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="nname" class="col-sm-4 text-right control-label col-form-label">Retailer ID <code>*</code></label>
                                    <div class="col-sm-8">
                                    <input type="text" class="form-control required-field" id="rid" name="rid" placeholder="Retailer ID Here"  onblur="validateField(this)" oninput="validateField(this)"
                                        readonly>
                                        <span class="error-message"></span>
                                    </div>                                    
                            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    document.getElementById('rid').value = generateUniqueID();
});
</script>
<div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                            <label for="nname" class="col-sm-4 text-right control-label col-form-label">Manufacturer ID <code>*</code></label>
                                    <div class="col-sm-8">
                        ...
                        <div class="col-sm-12 col-lg-6">
                            ...
                            <label for="nname" class="col-sm-4 text-right control-label col-form-label">Distributor ID <code>*</code></label>
                                    <div class="col-sm-8">
                                        <input name="disid" id="disid" class="form-control required-field" value="<?php echo $DistributorID; ?>" readonly>
                                        <span class="error-message"></span>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class="row">    
                        <div class="col-sm-12 col-lg-6">
                            ...
                            <label for="nname" class="col-sm-4 text-right control-label col-form-label">Dealer ID <code>*</code></label>
                                    <div class="col-sm-8">
                                        <input name="deaid" id="deaid" class="form-control required-field" value="<?php echo $DealerID; ?>" readonly>
                                        <span class="error-message"></span>
                                    </div>                                    
                            </div>
                        </div>                   
            ...
            <!-- <label for="nname" class="col-sm-4 text-right control-label col-form-label" >RoleU_ID<code>*</code></label> -->
                <div class="col-sm-8">
                <input type="hidden" class= "form-control" id="ruid" name= "ruid"  placeholder="Role UniqueId">
                <span class="error-message"></span>
                </div>                                    
            </div>
            </div>
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="form-group row">
                                    <label class="col-sm-4 text-right control-label col-form-label" style= "white-space: nowrap;">Latitude <code>*</code></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control required-field" id="slatitude" name="slatitude" placeholder="Retailer Latitude Here"  onblur="validateField(this)" oninput="validateField(this)"  required>
                                            <span class="error-message"></span>
                                        </div>                                                   
                                </div>
                            </div>
                            <div class="col-sm-12 col-lg-6">
                                <div class="form-group row">
                                    <label class="col-sm-4 text-right control-label col-form-label" style="white-space: nowrap;">Longitude <code>*</code></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control required-field" id="slangitude" name="slagitude" placeholder="Retailer Longitude Here"  onblur="validateField(this)" oninput="validateField(this)"  required>
                                            <span class="error-message"></span>
                                        </div>                                                    
                                </div>
                            </div>                                            
...
function checkEmail() {
    ...
    if (email) {
        ...
        xhr.send(JSON.stringify({ email: email, action: 'createRetailer' })); // Change action based on your needs
    } else {
...
</script>                     <div class="col-sm-12 col-lg-6">
                        <div class="form-group row">
                    ...
                    <div class="row">                         
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                <label for="email2" class="col-sm-4 text-right control-label col-form-label">Email</label>
                                <div class="col-sm-8">
                                    <input type="email" class="form-control" id="cp2email" name="cp2email" placeholder="Email Here" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" >
                                    </div>                                    
                            </div>
                        </div>
                    </div>
    ...
    <hr style="margin-top: -15px; margin-bottom: -4px; background: grey; opacity: 0.5;">
                ...
                <div class="row">                            
                    <div class="col-sm-12 col-lg-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                            <textarea name="notes" id="notes" class="form-control"  placeholder="Notes Here"></textarea>                                    
                            </div>                                    
                        </div>
                    </div>
                </div>
        ...
        <div class="card-body">
            <div class="form-group mb-0 d-flex justify-content-between align-items-center">
                <button type="submit" class="btn btn-success waves-effect waves-light" name="savebtn" id="savebtn"  disabled onclick="validateAllRequiredFields()" onblur="checkEmail()" oninput="checkEmail()">Submit</button>
            </div>
        </div>
    </form>
</div>
