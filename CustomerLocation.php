...
function get_confirmed_locations() {
    ...
    while ($r = mysqli_fetch_assoc($result)) {
        $locations[] = array($r['fdLatitude'], $r['fdLongitude'], $r['fdCustomerID'], '60'); // '50' represents dealer
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div id="legend">
                    ...
                    <div style="display: contents;"><span class="legend-marker" style="background-color: #e8d89e;"></span> Customer</div>
