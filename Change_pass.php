...
<div class="container-login100" style="background-image: url('image/products/FPbackgroundimg.jpg');">
            ...
            <div class="wrap-input100 validate-input" data-validate = "">
						<input class="input100" type="hidden" name="roleid" id="roleid" placeholder="Enter Your Id" >
...
if(isset($_POST['resetBtn'])){
    ...
    if($newpassword === $confirmnewpassword){
        $sql = "UPDATE tbUserMaster SET fdPassword ='$newpassword' WHERE fdEmailAsUserID = '$email' AND fdRoleUniqueID= '$roleid'";
