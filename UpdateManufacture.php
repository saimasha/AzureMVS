...
$time = date('H:i:s', strtotime($currentDateTime));
        ...
        $sql = "SELECT * FROM tbManufacturerMaster WHERE fdManufacturerID = '$manufacture_id' ";
...
<div class="row">
    <div class="col-12 mt-2">
        <div class="card">
            ...
            <h4 class="mb-0 text-white"><strong>UPDATE MANUFACTURER</strong></h4>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">     
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                            <input type="text" class="form-control required-field" id="mname" name="mname" value="<?php echo $rows["fdManufacturerName"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>
                        ...
                        <div class="col-sm-12 col-lg-6">
                            ...
                            <div class="col-sm-8">
                                    ...
                                    <input type="text" class="form-control" id="mid" name="mid"  value="<?php echo $manufacture_id; ?>" readonly> 
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                            <input type="text" class="form-control" id="iid" name="iid"  value="<?php echo $rows["fdIndustryID"]; ?>" readonly> 
                            </div>                                                
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                            <input type="text" class="form-control" id="gid" name="gid"  value="<?php echo $rows["fdGroupID"]; ?>" readonly>
                            </div>                                    
                        </div>
                    </div>
                    </div>
...
<div class="row">
    <div class="col-sm-12 col-lg-6">
        <div class="form-group row">
            ...
            <div class="col-sm-8" style="display: flex;">
                <input type="text" class="form-control required-field" id="mlatitude" name="mlatitude" value="<?php echo $rows["fdManufacturerLat"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>
                <span class="error-message"></span>
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="form-group row">
            ...
            <div class="col-sm-8" style="display: flex;">
                <input type="text" class="form-control required-field" id="mlongitude" name="mlongitude" value="<?php echo $rows["fdManufacturerLong"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>
                <span class="error-message"></span>
...
<div class="card-body">
    ...
    <div class="col-sm-8">
    <input type="text" class="form-control required-field" id="haname"  name="haname" value="<?php echo $rows["fdHighestAuthorityName"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>
    <span class="error-message"></span>
    </div>                               
    </div>
    </div>
    ...
    <div class="col-sm-8">
    <input type="text" class="form-control required-field" name="haposition" id="haposition" value="<?php echo $rows["fdHighestAuthorityPosition"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>
    <span class="error-message"></span>
    </div>                                
    </div>
    </div>
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="form-group row">
            ...
            <div class="col-sm-8">
            <input type="tel" class="form-control required-field" id="haphonenumber" name="haphonenumber"  value="<?php echo $rows["fdHighestAuthorityPhoneNumber"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>
            <span class="error-message"></span>
            </div>                                   
        </div>
    </div>
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="form-group row">
            ...
            <div class="col-sm-8">
            <input type="email" class="form-control required-field" id="haemail" name="haemail" value="<?php echo $rows["fdHighestAuthorityEmail"]; ?>" onblur="validateField(this)" oninput="validateField(this)" required>
            <span class="error-message"></span>
            </div>                                   
        </div>
    </div>                          
